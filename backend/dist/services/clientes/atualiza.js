...
class atualiza_cadastro {
    ...
    execute(_a) {
        return __awaiter(this, arguments, void 0, function* ({ nome, nascimento, tipo, cpf, id, observacao, contatos, endereco }) {
            ...
            const [resultadoPesq] = yield conexao_1.conexao.execute(queryPesq, [id]);
            ...
            try {
                ...
                yield this.atualizarCliente(conn, clienteAtual, { nome, nascimento, tipo, cpf, observacao, id });
                yield this.atualizarEndereco(conn, clienteAtual, endereco, id);
                yield this.atualizarContatos(conn, clienteAtual, contatos, id);
                yield conn.commit();
    ...
    atualizarCliente(conn, clienteAtual, dadosCliente) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (campos.length > 0) {
                ...
                yield conn.execute(query, campos);
            }
        });
    }
    atualizarEndereco(conn, clienteAtual, endereco, id) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    atualizarContatos(conn, clienteAtual, contatos, id) {
        return __awaiter(this, void 0, void 0, function* () {
